...
public class TopoSort {
    ...
    public static void main(String[] args){
        int[] from={7,7,5,3,3,11,11,11,8};
        int[] to={11,8 ,11,8,10,2,9,10,9};
        Graph graph = Graph.createGraph(12,from,to);
        int[] ar= topologicalSort(graph);
        ...
        for(int i=0; i<ar.length; i++){
            if(s.contains(i)){
                System.out.println("position of node " + i + " is " + ar[i]);
            }
        }
